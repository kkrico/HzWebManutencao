<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="webAtivoObra.aspx.cs" Inherits="HzWebManutencao.CentroCusto.webAtivoObra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div  style="position:relative; height: 499px; width: 1157px; top: 6px; left: -54px; margin-left: 40px;">
       ...
       <div style=" position:absolute; height: 49px; width: 1984px; top: 10px; left: 20px; margin-bottom: 22px;">
          <uc1:Navegacao ID="Navegacao1" runat="server" style="position:relative; top: 0px; left: 509px; height: 12px; width: 139px;"/>

        </div>

        <asp:Panel ID="pnlCadastraMaterial" runat="server" 
            
            style="position:absolute; left:10px; width:1144px; height:111px; top: 22px;">
            
            <asp:Label ID="lblEquipamento" runat="server" Text="Descrição do Equipamento"
                
                
                style="position:absolute; top: 49px; left: 29px; height: 15px; width: 167px;"></asp:Label>
            <asp:TextBox ID="txtDcEquipamentoPesq" runat="server"
                style="position:absolute; top: 71px; left: 28px; height: 16px; width: 264px;" 
            ...
            <asp:Label ID="lblTipoEquipamento" runat="server" Text="Tipo do Equipamento"
                ...
                style="position:absolute; top: 44px; left: 331px; height: 15px; width: 137px;"></asp:Label>
            <asp:DropDownList ID="cmbTipoEquipamento" runat="server" AutoPostBack="True" 
                ...
                style="position:absolute; top: 67px; left: 330px; width: 378px; height: 21px;"></asp:DropDownList>
         </asp:Panel>

        <asp:Button ID="btnPesquisa" runat="server" Text="Pesquisar" 
            style="position:absolute; top: 26px; left: 733px; height: 30px; width: 88px;" 
            CausesValidation="false" onclick="btnPesquisa_Click"/>
        <asp:Button ID="btnNovo" runat="server" Text="Novo" 
            style="position:absolute; top: 27px; left: 831px; height: 30px; width: 88px;" 
            CausesValidation="false" onclick="btnNovo_Click"/>

       <asp:GridView ID="grdPesquisa" runat="server" 
            style="position:absolute; top: 126px; left: 13px; width: 1150px; " AllowPaging="True" 
            ...
            onselectedindexchanged="grdPesquisa_SelectedIndexChanged1" PageSize="5">
            <Columns>
