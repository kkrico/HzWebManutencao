<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="webFAT_FaturamentoObraDetalhe.aspx.cs" Inherits="HzWebManutencao.Faturamento.webFAT_FaturamentoObraDetalhe" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div  style="position:relative; height: 393px; width: 1128px; top: 12px; left: -65px; margin-left: 80px;">

        <asp:Label ID="Label9" runat="server" 
        style="position:absolute; top: 5px; left: 5px; width: 1088px; text-align: center;" 
        Text="Emissão da Nota Fiscal GrupoOrion" Font-Bold="True" 
       ...
       <asp:Label ID="lblNomeObra" runat="server" 
            style="position:absolute; top: 28px; left: 145px; width: 658px;" 
       ...
       <asp:Label ID="Label4" runat="server" 
            style="position:absolute; top: 91px; left: 591px; width: 106px; " 
      ...
      <asp:Label ID="Label6" runat="server" 
       ...
       <asp:TextBox ID="txtNumeroDoc" runat="server"
        ...
        <asp:Label ID="DadosCarta" runat="server" Text="Dados Carta Orion" 
                style="position:absolute; top: 157px; left: 675px; height: 16px; width: 140px; right: 313px;" 
                Font-Size="Small" Font-Bold="True"></asp:Label>

        <asp:Label ID="Label7" runat="server" Text="Tipo de Serviço :" 
            style="position:absolute; top: 123px; left: 13px; width: 93px;"></asp:Label>
      <asp:TextBox ID="txtNomeServico" runat="server"  Enabled="false"
            style="position:absolute; top: 118px; left: 128px; width: 452px; "></asp:TextBox>
       ...
       <asp:TextBox ID="txtEmailEng" runat="server"
            style="position:absolute; top: 235px; left: 672px; width: 386px; " 
            TabIndex="8"></asp:TextBox>

        <asp:Label ID="Label11" runat="server" Text="Email Assistente Administrativo" 
            style="position:absolute; top: 271px; left: 674px; width: 162px;"></asp:Label>
       <asp:TextBox ID="txtEmailAux" runat="server"
            style="position:absolute; top: 285px; left: 672px; width: 384px; " 
