<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="web_ServicosManutencao.aspx.cs" Inherits="HzWebManutencao.ATE.web_ServicosManutencao" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="position:relative; height: 469px; width: 1154px; top: 12px; left: -54px; margin-left: 40px;">
            ...
            <asp:Label ID="Label10" runat="server" Text="E-mail Para Contato:" 
                style="position:absolute; top: 218px; left: 11px;"></asp:Label>
                <asp:Label ID="Label22" runat="server" Text="Equipamento" 
                style="position:absolute; top: 244px; left: 11px;"></asp:Label>
            <asp:TextBox ID="txtEmail" runat="server" 
                style="position:absolute; top: 214px; left: 143px; width: 535px;" 
                TabIndex="5"></asp:TextBox>
                            <asp:TextBox ID="TextBox1" runat="server" 
                style="position:absolute; top: 242px; left: 143px; width: 493px;" 
                TabIndex="5" BackColor="#CCCCCC" Enabled="False"></asp:TextBox>
            ...
            <asp:Label ID="Label8" runat="server" Text="Técnico:" 
                style="position:absolute; top: 246px; left: 716px;"></asp:Label>
                            <asp:Label ID="Label31" runat="server" Text="Solicitação:" 
                style="position:absolute; top: 212px; left: 716px;"></asp:Label>
            <asp:DropDownList ID="cmbSolicitacao" runat="server" 
                style="position:absolute; top: 215px; left: 840px; width: 269px;" 
                TabIndex="11"></asp:DropDownList>
                            <asp:DropDownList ID="DropDownList1" runat="server" 
                style="position:absolute; top: 240px; left: 840px; width: 269px;" 
                TabIndex="11"></asp:DropDownList>
            ...
            <asp:Label ID="Label11" runat="server" Text="Detalhamento da Solicitação:" 
                style="position:absolute; top: 305px; left: 16px; width: 179px;"></asp:Label>
            <asp:TextBox ID="txtObservacoes" runat="server" 
                style="position:absolute; top: 324px; left: 11px; width: 1096px; height: 46px;" 
           ...
           <asp:Button ID="btnExcluir" runat="server" Text="Excluir" Font-Size="X-Small" Font-Bold="True"
                style="position:absolute; top: 389px; left: 515px; width: 64px; height: 22px;" 
        ...
        <asp:Label ID="lbOSAndamento" runat="server" Text="Andamentos da Ordem de Serviço"
            style="position:absolute; top: 292px; left: 375px; font-weight: 700;"></asp:Label>
        <asp:ImageButton ID="imgAndamento" runat="server" CausesValidation="False"
            style="position:absolute; top: 285px; left: 335px; width: 34px; height: 28px;" 
       ...
       <asp:Panel ID="pnlAndamento" runat="server" BackColor="#FFFFCC" Height="543px" Width="900px"
            ...
            <asp:Label ID="Label30" runat="server" 
                style="position:absolute; top: 215px; left: 11px;" Text="E-mail Para Contato:"></asp:Label>
        ...
        <asp:Label ID="lblJustifica" runat="server" Text="Justificativa"
            style="position:absolute; top: 294px; left: 675px; font-weight: 700;"></asp:Label>
        <asp:ImageButton ID="ImgJustifica" runat="server" CausesValidation="False"
            style="position:absolute; top: 282px; left: 639px; width: 34px; height: 28px;" 
       ...
       <asp:Panel ID="pnlJustificativa" runat="server" BackColor="#FFFFCC"  Height="243px" Width="592px"
        ...
        <asp:Label ID="lblConclusao" runat="server" Text="Visualizar Conclusão Ordem de Serviço"
            style="position:absolute; top: 291px; left: 674px; font-weight: 700;"></asp:Label>
        <asp:ImageButton ID="ImgConclusao" runat="server" CausesValidation="False"
            style="position:absolute; top: 281px; left: 639px; width: 34px; height: 28px;" 
            ImageUrl="~/Imagens/7155_32x32.png"/>
            <asp:ModalPopupExtender 
    ...
    <asp:BalloonPopupExtender ID="PopupControlExtender2" runat="server"
            ...
            DisplayOnClick="true"/>
                ...
                Font-Size="X-Small" Font-Bold="True"
                style="position:absolute; top: 240px; left: 656px; width: 24px; height: 20px;" 
                onclick="btnExcluir_Click" TabIndex="700"/>
