...
{
    public partial class webMTO_ConsumoReativo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (DataTable table = tblUsuario.Get(Global.GetConnection(), ls))
            {
                ...
                {
                    string filename = "webMNT_Geral.aspx?tipo=reativo" + "&co_usuario=" + table.Rows[0]["chavemanto"].ToString();
