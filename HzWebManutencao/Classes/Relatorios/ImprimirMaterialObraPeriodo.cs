...
{
    public class ImprimirMaterialObraPeriodo
    {
        #region Variables
        /// <summary>
        /// Documento PDF
        ...
        protected void CabRelatorio()
        {
            ...
            //}
            //top += 10;
            myPage.addText("LISTA DE MATERIAL POR OBRA", 220, getTop(myPage, top),myDoc.getFontReference(strFont), 12, pdfColor.Black);
            top += 10;
            myPage.addText("___________________________________________________________________________________", leftMargin, getTop(myPage, top),
            ...
            myTable.tableHeader[cl++].addText("OBRA: " + NomeObra.ToString().TrimEnd());
            ...
            //myRow[cl++].addText("PERÍODO: " + DtInicial + " a " + DtFinal);
